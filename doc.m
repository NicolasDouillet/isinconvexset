...
%% See also 
%
% | <https://fr.mathworks.com/matlabcentral/fileexchange/182100-ispointin3dtriangle isPointin3Dtriangle> | 
%   <https://fr.mathworks.com/matlabcentral/fileexchange/122962-isinside2dset isinside2dset> |
%   <https://fr.mathworks.com/help/matlab/ref/convhull.html?s_tid=srchtitle convhull> |
%   <https://fr.mathworks.com/help/matlab/ref/inpolygon.html?searchHighlight=inpolygon&s_tid=srchtitle_inpolygon_1 inpolygon> |
%
%% Input arguments
%
%        [ |  |  |]
...
cellfun(@(r1,r2) plot(r1(1,1),r1(1,2),'+','Color',r2,'MarkerSize',2,'LineWidth',2),num2cell(M,2),ColorSpec,'un',0);
...
colormap([0 1 1]);
ColorSpec = num2cell(cat(2,~isin,isin,zeros(size(isin,1),1)),2);
cellfun(@(r1,r2) plot3(r1(1,1),r1(1,2),r1(1,3),'+','Color',r2,'MarkerSize',2,'LineWidth',2),num2cell(M,2),ColorSpec,'un',0);
